	...
	<div class="col-md-6">
		<div class="form-group">
			<div class="col-md-6">
				...
				<?= Form::select('rate_type', Input::post('rate_type', isset($booking) ? $booking->rate_type : ''), Model_Rate::listOptions(isset($unit) ? $unit->unit_type : $booking->unit->rm_type->id), array('class' => 'col-md-4 form-control', 'id' => 'rate_type', 'readonly' => true)); ?>
			</div>

			<!-- <div class="col-md-4">
				<label class='control-label'>&nbsp;</label><br>
				<a href="<?= Uri::create('#unit/transfer'); ?>" class="btn btn-default btn-xs btn-default disabled">

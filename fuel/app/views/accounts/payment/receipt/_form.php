<?= Form::open(array("class"=>"form-horizontal", "autocomplete" => "off")); ?>
	...
	<div class="form-group">
		<div class="col-md-4">
            ...
            <?= Form::input('payer', Input::post('payer', isset($payment_receipt) ? 
                            $payment_receipt->payer : $bill->guest->first_name .' '. $bill->guest->last_name), 
    ...
    <div class="form-group">
        <div class="col-md-2">
            ...
            <?= Form::select('payment_method', Input::post('payment_method', isset($payment_receipt) ? $payment_receipt->payment_method : ''), 
                            Model_Accounts_Payment_Method::listOptions(isset($payment_receipt) ? 
                            $payment_receipt->payment_method : $payment_receipt->payment_method), 
                            array('class' => 'col-md-4 form-control')); ?>
        </div>
        <div class="col-md-2">
	...
	<div class="form-group">
		<div class="col-md-2">
            ...
            <?= Form::input('amount', Input::post('amount', isset($payment_receipt) ? $payment_receipt->amount : $bill->balance_due), 
	...
	<div class="form-group">
		<div class="col-md-4">
            ...
            <?= Form::input('description', Input::post('description', isset($payment_receipt) ? $payment_receipt->description : 
                            'Accommodation for Unit no. ' . $bill->guest->unit->name), 
                            array('class' => 'col-md-4 form-control')); ?>
		</div>
	</div>

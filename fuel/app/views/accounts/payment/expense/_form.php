<?= Form::open(array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		<div class="col-md-2">
			...
			<div class="input-group">
				...
				<?= Form::input('reference', Input::post('reference', isset($expense) ? $expense->reference : Model_Accounts_Payment_Expense::getNextSerialNumber()), array('class' => 'col-md-4 form-control', 'readonly' => true)); ?>
			</div>
		</div>
		<div class="col-md-2">
			<?= Form::label('Date', 'date', array('class'=>'control-label')); ?>
			<!-- <div class="input-group"> -->
				<?= Form::input('date', Input::post('date', isset($expense) ? $expense->date : date('Y-m-d')), array('class' => 'col-md-4 form-control datepicker')); ?>
	...
	<div class="form-group">
		<div class="col-md-4">
			...
			<?= Form::input('payee', Input::post('payee', isset($expense) ? $expense->payee : ''), array('class' => 'col-md-4 form-control')); ?>
		</div>
	</div>
	...
	<!-- <div class="form-group">
		...
		<?= Form::input('gl_account_id', Input::post('gl_account_id', isset($expense) ? $expense->gl_account_id : ''), array('class' => 'col-md-4 form-control')); ?>
	</div> -->

	<!-- <div class="form-group">
		<?= Form::label('Tax id', 'tax_id', array('class'=>'control-label')); ?>
		<?= Form::input('tax_id', Input::post('tax_id', isset($expense) ? $expense->tax_id : 0), array('class' => 'col-md-4 form-control')); ?>
	</div> -->

	<!-- <div class="form-group">
		<?= Form::label('Bank account', 'bank_account_id', array('class'=>'control-label')); ?>
		<?= Form::input('bank_account_id', Input::post('bank_account_id', isset($expense) ? $expense->bank_account_id : ''), array('class' => 'col-md-4 form-control')); ?>
	</div> -->
    ...
    <!--<div class="form-group">-->
        <!--<div class="col-md-4">-->
            ...
            <?php // Form::select('payment_type', Input::post('payment_type', isset($fd_booking) ? $fd_booking->payment_type : ''), Model_Accounts_Payment_Receipt::$payment_type, array('class' => 'col-md-4 form-control')); ?>
        <!--</div>-->
    ...
    <!--<div class="form-group">-->
        <!--<div class="col-md-4">-->
            ...
            <?php // Form::select('card_type', Input::post('card_type', isset($fd_booking) ? $fd_booking->card_type : ''), Model_Accounts_Payment_Receipt::$card_type, array('class' => 'col-md-4 form-control')); ?>
        <!--</div>-->
    <!--</div>-->

<?= Form::open(array("class"=>"form-horizontal", "autocomplete" => "off")); ?>
	...
	<div class="form-group">
		<div class="col-md-2">
			...
			<div class="input-group">
				...
				<?= Form::input('reference', Input::post('reference', isset($bank_deposit) ? $bank_deposit->reference : ''), array('class' => 'col-md-4 form-control', 'autofocus' => true)); ?>
			</div>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="col-md-2">
			...
			<?= Form::input('date', Input::post('date', isset($bank_deposit) ? $bank_deposit->date : ''), array('class' => 'col-md-4 form-control datepicker')); ?>
		</div>
	...
	<div class="form-group">
		<div class="col-md-4">
			...
			<?= Form::input('payer', Input::post('payer', isset($bank_deposit) ? $bank_deposit->payer : 'Manager'), array('class' => 'col-md-4 form-control')); ?>
		</div>
	</div>

	<!-- <div class="form-group">
		<?= Form::label('GL account', 'gl_account_id', array('class'=>'control-label')); ?>
		<?= Form::input('gl_account_id', Input::post('gl_account_id', isset($bank_deposit) ? $bank_deposit->gl_account_id : ''), array('class' => 'col-md-4 form-control')); ?>
	</div> -->

	<!-- <div class="form-group">
		<?= Form::label('Tax id', 'tax_id', array('class'=>'control-label')); ?>
		<?= Form::input('tax_id', Input::post('tax_id', isset($bank_deposit) ? $bank_deposit->tax_id : ''), array('class' => 'col-md-4 form-control')); ?>
	</div> -->

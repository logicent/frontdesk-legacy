<?= Form::open(array("class"=>"form-horizontal", "autocomplete" => "off")); ?>
	...
	<div class="form-group">
		<div class="col-md-4">
			...
			<?= Form::input('name', Input::post('name', isset($bank_account) ? $bank_account->name : ''), array('class' => 'col-md-4 form-control', 'autofocus' => true)); ?>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="col-md-4">
			...
			<?= Form::input('account_number', Input::post('account_number', isset($bank_account) ? $bank_account->account_number : ''), array('class' => 'col-md-4 form-control')); ?>
		</div>
	</div>
	...
	<!-- <div class="form-group">
		<div class="col-md-3">
			...
			<?= Form::checkbox('i_banking_na', Input::post('i_banking_na', isset($bank_account) ? $bank_account->i_banking_na : ''), array('class' => 'col-md-4 form-control')); ?>
		</div>
	</div> -->

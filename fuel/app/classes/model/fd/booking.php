...
class Model_Fd_Booking extends Model_Soft
{
	...
	{
		return Model_Fd_Booking::find('first', array('where' => array('room_id' => $rm_id, array('status', '!=', self::GUEST_STATUS_CHECKED_OUT))));
	}
}

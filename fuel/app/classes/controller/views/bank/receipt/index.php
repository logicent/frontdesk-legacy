<div class="row">
	...
	<div class="col-md-6">
		<br>
		<?= Html::anchor('bank/receipt/create', '<i class="fa fa-plus"></i>&ensp;Deposit', array('class' => 'btn btn-primary pull-right')); ?>
	</div>
</div>
<hr>
...
<?php foreach ($bank_receipts as $item): ?>
		<tr>
			...
			<td class="text-center">
				...
				<?= Html::anchor('bank/receipt/delete/'.$item->id, '<i class="fa fa-trash-o fa-fw fa-lg"></i>', array('class' => 'text-danger', 'onclick' => "return confirm('Are you sure?')")); ?>
			</td>
		</tr>
<?php endforeach; ?>
	</tbody>

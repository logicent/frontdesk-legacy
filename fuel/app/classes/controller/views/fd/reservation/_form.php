	...
	<div class="col-md-6">
		<div class="form-group">
			<div class="col-md-6">
				...
				<?= Form::input('first_name', Input::post('first_name', isset($fd_reservation) ? $fd_reservation->first_name : ''), array('class' => 'col-md-4 form-control', 'autofocus' => true)); ?>
			</div>

			<div class="col-md-6">
				<?= Form::label('Last name', 'last_name', array('class'=>'control-label')); ?>
				<?= Form::input('last_name', Input::post('last_name', isset($fd_reservation) ? $fd_reservation->last_name : ''), array('class' => 'col-md-4 form-control')); ?>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-md-6">
				...
				<?= Form::input('email', Input::post('email', isset($fd_reservation) ? $fd_reservation->email : ''),
array('class' => 'col-md-4 form-control')); ?>
			</div>

			<div class="col-md-6">
				<?= Form::label('Phone', 'phone', array('class'=>'control-label')); ?>
				<?= Form::input('phone', Input::post('phone', isset($fd_reservation) ? $fd_reservation->phone : ''),
array('class' => 'col-md-4 form-control')); ?>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-md-6">
				...
				<?= Form::input('city', Input::post('city', isset($fd_reservation) ? $fd_reservation->city : ''),
										array('class' => 'col-md-4 form-control')); ?>
			</div>

			<div class="col-md-6">
				<?= Form::label('Country', 'country', array('class'=>'control-label')); ?>
				<?= Form::select('country', Input::post('country', isset($fd_reservation) ? $fd_reservation->country : Model_Country::getDefaultCountry()), Model_Country::listOptions(false, ''), array('class' => 'col-md-4 form-control')); ?>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<?= Form::textarea('address', Input::post('address', isset($fd_reservation) ? $fd_reservation->address : ''),
...
Model_Fd_Booking::$ID_type, array('class' => 'col-md-4 form-control')); ?>
			</div>

			<div class="col-md-6">
				<?= Form::label('ID number', 'id_number', array('class'=>'control-label')); ?>
				<?= Form::input('id_number', Input::post('id_number', isset($fd_reservation) ? $fd_reservation->id_number : ''), array('class' => 'col-md-4 form-control')); ?>
			</div>
		</div>
...
<div class="form-group">
	...
	<div class="col-md-6">
		...
		<div class="pull-right btn-toolbar">
			<div class="btn-group">
				<!-- <a href="<?php // echo Uri::create('fd/reservation/confirm/'.$fd_reservation->id); ?>" class="btn btn-warning">Confirm booking</a> -->
			</div>
		</div>
		<?php endif; ?>
	</div>
